...
-- Restore unit menggunakan site id canonical dari code, bukan hardcoded id.
DO $ DECLARE
  tod_id integer;
  sc_id integer;
BEGIN
  ...
  IF tod_id IS NOT NULL THEN
    INSERT INTO mall_units (unit_code, floor, zone, size_m2, status, position_x, position_y, width, height, site_id) VALUES
    ('T-001','1','Zona A',20,'occupied',0,0,2,2,tod_id),
    ('T-002','1','Zona A',16,'occupied',2,0,2,2,tod_id),
    ('T-003','1','Zona A',14,'occupied',4,0,2,2,tod_id),
    ('T-004','1','Zona A',18,'occupied',6,0,2,2,tod_id),
    ('T-005','1','Zona B',20,'occupied',0,2,2,2,tod_id),
    ('T-006','1','Zona B',16,'occupied',2,2,2,2,tod_id),
    ('T-007','1','Zona B',14,'occupied',4,2,2,2,tod_id),
    ('T-008','1','Zona B',18,'available',6,2,2,2,tod_id),
    ('T-009','1','Zona A',20,'occupied',0,4,2,2,tod_id),
    ('T-010','1','Zona A',16,'occupied',4,4,2,2,tod_id),
    ('T-011','1','Zona B',20,'occupied',6,4,2,2,tod_id),
    ('T-012','1','Zona A',18,'occupied',0,6,2,2,tod_id),
    ('T-013','1','Zona B',24,'available',2,6,2,2,tod_id),
